...
const MyButton = styled(Button)({
  ...
  function Rekening(){
    ...
    const [namapem, setNamapem] = useState('');
    ...
    const ref = firebase.firestore().collection("Rekening_fotografer");
        ...
        <Container component ="main" maxWidth="xs" >
          ...
          <Grid container spacing={2}>
            ...
            <TextField 
                    ...
                    onChange = {(e) => setNamapem(e.target.value)}
            ...
            <Grid item xs={12} >
            <TextField variant="outlined"  onChange = {(e) => setNbank(e.target.value)} id="select" fullWidth label="Nama Bank" select>
            ...
            <MyButton onClick = {() => addSim({ namapem, norek, nbank, upfoto, uidauth , id : uuidv4()})} >Simpan</MyButton>
          </Grid>
          </div>
          <hr />
          {upfoto}
