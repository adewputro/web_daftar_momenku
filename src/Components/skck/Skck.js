...
const MyButton = styled(Button)({
  ...
  function Skck(){
    ...
    const [tglskck, setTglSkck] = useState('');
    ...
    const ref = firebase.firestore().collection("Skck_fotografer");
        ...
        <Container component ="main" maxWidth="xs" >
          ...
          <Grid container spacing={2}>
            ...
            <TextField 
                    ...
                    onChange = {(e) => setTglSkck(e.target.value)}
                    
            />
            </Grid>
         
            <MyButton onClick = {() => addSkck({ tglskck, upfoto, uidauth , id : uuidv4()})} >Simpan</MyButton>
          </Grid>
          </div>
          <hr />
          {upfoto}
